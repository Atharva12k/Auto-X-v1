...
namespace GSMCommDemo
{
	...
	public class frmConnection : System.Windows.Forms.Form
	{
		...
		private void frmConnection_Load(object sender, System.EventArgs e)
		{
            ...
            cboPort.Items.Add("COM13");
            cboPort.Items.Add("COM14");
            cboPort.Items.Add("COM15");
            cboPort.Items.Add("COM16");
            cboPort.Items.Add("COM17");
            cboPort.Items.Add("COM18");
            cboPort.Items.Add("COM19");
            cboPort.Items.Add("COM20");
