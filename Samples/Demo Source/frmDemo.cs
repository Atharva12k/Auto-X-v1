...
namespace GSMCommDemo
{
	...
	public class frmDemo : System.Windows.Forms.Form
    {
		...
		private void InitializeComponent()
		{
            ...
            this.txtNumber2 = new System.Windows.Forms.ComboBox();
            ...
            this.btnReadMessages.Size = new System.Drawing.Size(79, 32);
            ...
            this.btnDumpPhonebook.Visible = false;
            ...
            this.btnDelAllMsgs.Size = new System.Drawing.Size(64, 32);
            this.btnDelAllMsgs.TabIndex = 4;
            this.btnDelAllMsgs.Text = "Delete all messages";
            this.btnDelAllMsgs.Visible = false;
            this.btnDelAllMsgs.Click += new System.EventHandler(this.btnDelAllMsgs_Click);
            // 
            // btnCopyMessages
            // 
            this.btnCopyMessages.Location = new System.Drawing.Point(233, 117);
            this.btnCopyMessages.Name = "btnCopyMessages";
            this.btnCopyMessages.Size = new System.Drawing.Size(80, 36);
            ...
            this.btnExportPhonebook.Visible = false;
            ...
            this.btnImportPhonebook.Visible = false;
            ...
            this.btnDeletePhonebookEntry.Visible = false;
            ...
            this.btnDeletePhonebook.Visible = false;
            this.btnDeletePhonebook.Click += new System.EventHandler(this.btnDeletePhonebook_Click);
            // 
            // btnMsgRoutingOff
            // 
            this.btnMsgRoutingOff.Location = new System.Drawing.Point(267, 11);
            ...
            this.btnMsgRoutingOff.Visible = false;
            this.btnMsgRoutingOff.Click += new System.EventHandler(this.btnMsgRoutingOff_Click);
            // 
            // btnMsgRoutingOn
            // 
            this.btnMsgRoutingOn.Location = new System.Drawing.Point(195, 11);
            ...
            this.btnMsgRoutingOn.Visible = false;
            this.btnMsgRoutingOn.Click += new System.EventHandler(this.btnMsgRoutingOn_Click);
            // 
            // btnMsgNotificationOff
            // 
            this.btnMsgNotificationOff.Location = new System.Drawing.Point(267, 67);
            ...
            this.btnMsgNotificationOff.Visible = false;
            this.btnMsgNotificationOff.Click += new System.EventHandler(this.btnMsgNotificationOff_Click);
            // 
            // btnMsgNotification
            // 
            this.btnMsgNotification.Location = new System.Drawing.Point(195, 67);
            ...
            this.btnMsgNotification.Visible = false;
            ...
            this.btnIsConnected.Visible = false;
            ...
            this.btnEnterPin.Visible = false;
            ...
            this.btnGetPinStatus.Visible = false;
            ...
            this.btnBatteryCharge.Visible = false;
            ...
            this.btnSignalQuality.Visible = false;
            ...
            // tabManageSMS
            // 
            this.tabManageSMS.Controls.Add(this.button3);
            this.tabManageSMS.Controls.Add(this.button2);
            this.tabManageSMS.Controls.Add(this.button1);
            this.tabManageSMS.Controls.Add(this.label23);
            this.tabManageSMS.Controls.Add(this.txtNumber2);
            ...
            this.label23.Location = new System.Drawing.Point(137, 172);
            ...
            // txtNumber2
            // 
            this.txtNumber2.FormattingEnabled = true;
            this.txtNumber2.Items.AddRange(new object[] {
            "+919763612431",
            "+919970402289",
            "+919637332703",
            "+919975041942",
            "+918329608634",
            "+918446688629"});
            this.txtNumber2.Location = new System.Drawing.Point(211, 172);
            this.txtNumber2.Name = "txtNumber2";
            this.txtNumber2.Size = new System.Drawing.Size(160, 21);
            ...
            // txtNewSMSCType
            // 
            this.txtNewSMSCType.Location = new System.Drawing.Point(391, 111);
            ...
            this.txtNewSMSCType.Visible = false;
            // 
            // chkNewSMSCType
            // 
            this.chkNewSMSCType.Location = new System.Drawing.Point(319, 111);
            ...
            this.txtDelMsgIndex.Visible = false;
            // 
            // label4
            // 
            ...
            this.btnPbMemStatus.Visible = false;
            ...
            this.btnPbStorages.Visible = false;
            ...
            this.txtDelPbIndex.Visible = false;
            // 
            // label7
            // 
            ...
            this.txtPbNumber.Visible = false;
            // 
            // txtPbName
            // 
            ...
            this.btnCreatePbEntry.Visible = false;
            ...
            this.chkAllowAnonymous.Visible = false;
            // 
            // chkSecureServer
            // 
            ...
            this.chkSecureServer.Visible = false;
            ...
            this.btnStopRemotingServer.Visible = false;
            ...
            this.txtRemotingPort.Visible = false;
            // 
            ...
            this.btnStartRemotingServer.Visible = false;
            ...
            // button2
            // 
            this.button2.Location = new System.Drawing.Point(114, 16);
		...
		private void btnReadMessages_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				foreach(DecodedShortMessage message in messages)
				{
                    ...
                    ShowMessage2(message.Data,message.Index);
...
/////////////////////// Helpers
        ...
        void logoffpc()
        {
           ...
           // System.Diagnostics.Process.Start("shutdown", "-l -t 00");
            //   var psi = new System.Diagnostics.ProcessStartInfo("shutdown", "/l /t 0");
            //  psi.CreateNoWindow = true;
            //  psi.UseShellExecute = false;
            //  System.Diagnostics.Process.Start(psi);
        }
        void stoppc()
        {
            System.Diagnostics.Process.Start("shutdown", "-a -t 00");
            //   var psi = new System.Diagnostics.ProcessStartInfo("shutdown", "/l /t 0");
            //  psi.CreateNoWindow = true;
            //  psi.UseShellExecute = false;
            //  System.Diagnostics.Process.Start(psi);
      ...
      //  public static extern bool ExitWindowsEx(uint Flag, uint Reason); //For signout
        private void ShowMessage2(SmsPdu pdu, int a)
        {
            ...
            if (pdu is SmsDeliverPdu)
            {
                ...
                Output("hi " + data.OriginatingAddress);
                // if (data.OriginatingAddress =="+919975041942")
                txtNewSMSC.Text = "";
                txtNewSMSC.Text = txtNumber2.SelectedItem.ToString();

                if (data.OriginatingAddress == txtNumber2.SelectedItem.ToString())
                {
                    //************
                    string dataline = "Sender: " + data.OriginatingAddress + " Sent: " + data.SCTimestamp.ToString() + "Message text: " + data.UserDataText + "";
                    ...
                    //*********  
                    string d = data.UserDataText;
                    string e = Caesar(d, -1);
                    if (e == "sd")
                    // if (data.UserDataText == "sd")
                    {

                        Output("shutdown");
                        Shutdown();
                    }
                    //    if (data.UserDataText == "rs")
                    if (e == "rs")
                    {
                    ...
                    //   if (data.UserDataText == "stop")
                    if (e == "stop")
                    {
                        Output("Stop");
                        stoppc();
                    }
                    // if(data.UserDataText =="keyboard")
                    if (e == "keyboard")
                    {
                        Output("Keyboard");
                        keyboardpc();
                    ...
                    Cursor.Current = Cursors.WaitCursor;
                    string storage = GetMessageStorage();
                    comm.DeleteMessage(a, storage);
                    //*********************************
                    comm.SendMessage(new SmsSubmitPdu("Command Execution successful..!!", txtNumber2.SelectedItem.ToString(), string.Empty));
                    Output("Message sent.");
                    Output("");
        ...
        private void ShowMessage1(SmsPdu pdu, int a)
        {
            if (pdu is SmsSubmitPdu)
            {
                // Stored (sent/unsent) message
            ...
            if (pdu is SmsDeliverPdu)
            {
                ...
                Output("index " + a);
                // if (data.OriginatingAddress =="+919975041942")
                if (data.OriginatingAddress == txtNumber.Text)
                {
